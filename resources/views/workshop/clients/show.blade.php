...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
            <a href="{{ route('workshop.clients.edit', $client) }}" class="inline-flex items-center justify-center rounded-xl border border-[#d8c7af] bg-white px-4 py-2.5 text-sm font-bold text-[#171411] hover:bg-[#fbf7f0]">Modifier</a>
            <a href="{{ route('workshop.orders.create', ['client_id' => $client->id]) }}" class="inline-flex items-center justify-center rounded-xl bg-[#171411] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#a47834]">+ Ajouter commande</a>
        </div>
    </div>
