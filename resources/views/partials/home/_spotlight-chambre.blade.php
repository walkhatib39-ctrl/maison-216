{{-- Category Spotlight: Chambre d'enfant (layout aligned with Salle &agrave; Manger) --}}
@if($products->count() > 0)
<section class="py-12 lg:py-20 bg-white">
    <div class="container mx-auto px-4">
        {{-- Section Header --}}
        <div class="text-center mb-10 lg:mb-12">
            <span class="inline-block bg-indigo-100 text-indigo-700 text-sm font-semibold px-4 py-1.5 rounded-full mb-4">
                Collection Enfant
            </span>
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-dark-900 mb-3">
                Chambre <span class="text-primary-600">d&rsquo;enfant</span>
            </h2>
            <p class="text-base lg:text-lg text-dark-600 max-w-2xl mx-auto">
                Offrez-vous des nuits de r&ecirc;ve avec notre s&eacute;lection de lits, armoires et tables de nuit.
                Confort premium et design &eacute;l&eacute;gant pour l&rsquo;espace le plus intime.
            </p>
        </div>
                        ...
                        <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden border border-dark-100 transition-all duration-300 hover:-translate-y-2">
                            ...
                            <div class="relative overflow-hidden">
                                <a href="{{ route('product.show', $product->slug) }}" class="block">
                                    <img src="{{ isset($product->main_image) ? asset($product->main_image) : 'https://images.unsplash.com/photo-1540518614846-7eded433c457?q=80&w=600&auto=format&fit=crop' }}"
                                         alt="{{ $product->title }}"
                                ...
                                <div class="absolute top-4 left-4">
                                    <span class="bg-indigo-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                                        Chambre d&rsquo;enfant
                                    </span>
                                </div>
                            </div>
        ...
        <div class="text-center mt-10">
            <a href="{{ route('category.show', 'chambres-enfant-completes') }}"
               class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl">
