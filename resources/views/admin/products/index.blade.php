            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" name="q" value="{{ $filters['q'] ?? '' }}"
                           ...
                           placeholder="Titre, SKU ou référence...">
        ...
        <table class="w-full">
            <thead class="bg-gradient-to-r from-dark-50 to-dark-100 border-b border-dark-200">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-dark-700 uppercase tracking-wider">Catégorie</th>
                ...
                @forelse($products as $p)
                    <tr class="hover:bg-dark-50 transition-colors duration-200 group">
                        ...
                        <td class="px-6 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="text-sm text-dark-600 mb-1">
                                        @if($p->sku)
                                        ...
                                        @else
                                            <span class="text-dark-400">Aucun SKU</span>
                                        @endif
                                    </div>
                                    @if($p->brand)
                        ...
                        <td class="px-6 py-6">
                            ...
                            @else
                                <span class="text-dark-400 text-sm">Non catégorisé</span>
                            @endif
                        </td>
                        <td class="px-6 py-6">
