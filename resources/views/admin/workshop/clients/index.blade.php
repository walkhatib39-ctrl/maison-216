...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
            <a href="{{ route('admin.workshop.orders.create') }}" class="inline-flex items-center justify-center rounded-xl border border-[#d8c7af] bg-white px-4 py-2.5 text-sm font-bold text-[#171411] transition hover:bg-[#fbf7f0]">
                + Ajouter commande
            </a>
            <a href="{{ route('admin.workshop.clients.create') }}" class="inline-flex items-center justify-center rounded-xl bg-[#171411] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#a47834]">
                + Ajouter client
            </a>
        </div>
    </div>
                        ...
                        <tr class="transition hover:bg-[#fbf7f0]">
                            ...
                            <td class="px-5 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.workshop.clients.show', $client) }}" class="rounded-xl border border-[#d8c7af] bg-white px-3 py-2 text-xs font-bold text-[#171411] hover:bg-[#fbf7f0]">Voir</a>
                                    <a href="{{ route('admin.workshop.clients.edit', $client) }}" class="rounded-xl border border-[#d8c7af] bg-white px-3 py-2 text-xs font-bold text-[#171411] hover:bg-[#fbf7f0]">Modifier</a>
                                </div>
                            </td>
                        </tr>
                    @empty
