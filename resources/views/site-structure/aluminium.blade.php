    ...
    <div class="container relative mx-auto grid gap-0 px-4 pb-12 pt-0 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-10 lg:py-20">
        <div class="order-2 py-10 lg:order-1 lg:py-0">
            ...
            <div class="mt-8 flex flex-row gap-2 sm:gap-3">
                ...
                @if($realizations->isNotEmpty())
                    <a href="#realisations-alu" class="inline-flex flex-1 items-center justify-center gap-2 rounded-full border border-[#cdbb9f] bg-white/78 px-4 py-3 text-xs font-extrabold text-[#171411] transition hover:border-[#a47834] hover:bg-white sm:flex-none sm:px-7 sm:py-4 sm:text-sm">
        ...
        <div class="order-1 -mx-4 lg:order-2 lg:mx-0">
            <div class="overflow-hidden bg-white lg:rounded-[40px] lg:border lg:border-[#d8c7af] lg:p-3">
                <img src="{{ $heroImage }}" alt="Menuiserie aluminium Maison216" class="h-[320px] w-full object-cover sm:h-[420px] lg:h-[540px] lg:rounded-[30px]">
            </div>
        </div>
    </div>
</section>
