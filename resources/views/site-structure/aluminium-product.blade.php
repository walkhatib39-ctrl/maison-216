...
<section id="realisations-aluminium" class="bg-[#171411] py-16 text-white lg:py-20">
    <div class="container mx-auto px-4">
        ...
        <div class="grid gap-5 md:grid-cols-3">
            @foreach([
                ['type' => $data['name'], 'place' => 'Sur mesure', 'image' => $data['heroImage'], 'copy' => 'Fabrication atelier, finition et pose sur site.'],
                ['type' => 'Projet villa', 'place' => 'Résidentiel', 'image' => $villaImage, 'copy' => 'Solution adaptée à une maison ou une terrasse.'],
                ['type' => 'Projet professionnel', 'place' => 'Commercial', 'image' => $restaurantImage, 'copy' => 'Ouvrage pensé pour usage intensif et image du lieu.'],
            ] as $realization)
