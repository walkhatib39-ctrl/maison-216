...
<head>
  ...
  <title>Page introuvable — Maison 216</title>
    ...
    <main class="card" role="main" aria-labelledby="title-404">
      <section class="top">
        <span class="badge" aria-hidden="true">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M3 4a1 1 0 011-1h6.279a1 1 0 01.707.293l1.721 1.721A1 1 0 0013.414 6H20a1 1 0 011 1v2h-2V8H5v10h6v2H4a1 1 0 01-1-1V4z"/><path d="M21 13.5a3.5 3.5 0 11-6.234 2.171L12 18.438V21h-2v-3a1 1 0 01.293-.707l3.1-3.1A3.5 3.5 0 1121 13.5zm-3.5-1.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"/></svg>
          Erreur 404
        </span>
        <h1 id="title-404" class="title">Page introuvable</h1>
        <p class="desc">Désolé, la page que vous cherchez n’existe pas ou a été déplacée.</p>
      </section>
      ...
      <section class="content">
        <div class="panel">
          ...
          <div class="links" role="navigation" aria-label="Liens utiles">
            ...
            <a href="{{ url('/menuiserie-bois') }}" class="btn btn-secondary">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h10v2H4z"/></svg>
              Voir nos métiers
            </a>
            <a href="{{ url('/legal/cgv') }}" class="btn btn-secondary">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2a1 1 0 00-1 1v17l7-3 7 3V3a1 1 0 00-1-1H6z"/></svg>
