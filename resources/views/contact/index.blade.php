        ...
        <div class="lg:col-span-5 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-dark-100 p-6 shadow-sm">
                ...
                <ul class="space-y-2 text-dark-700">
                    @if($phoneDisplay)<li><strong>Téléphone / WhatsApp:</strong> {{ $phoneDisplay }}</li>@endif
                    @if($publicEmail)<li><strong>Email:</strong> {{ $publicEmail }}</li>@endif
                    @if($address)<li><strong>Atelier:</strong> {{ $address }}</li>@endif
                    @if($serviceArea)<li><strong>Zone:</strong> {{ $serviceArea }}</li>@endif
