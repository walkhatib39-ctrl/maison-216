...
class WorkshopClientController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('admin.workshop.clients.index', [
            'clients' => $clients,
            'filters' => $filters,
    ...
    {
        return view('admin.workshop.clients.form', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.workshop.clients.show', $client)
    ...
    public function show(WorkshopClient $client): View
    {
        ...
        return view('admin.workshop.clients.show', compact('client'));
    }
    ...
    public function destroy(WorkshopClient $client): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.workshop.clients.index')
