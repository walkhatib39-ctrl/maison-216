...
class WorkshopOrderController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('admin.workshop.orders.index', [
            'orders' => $orders,
            'filters' => $filters,
    ...
    {
        return view('admin.workshop.orders.form', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.workshop.orders.show', $order)
    ...
    public function show(WorkshopOrder $order): View
    {
        ...
        return view('admin.workshop.orders.show', compact('order'));
    }
    ...
    public function destroy(WorkshopOrder $order): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.workshop.orders.index')
